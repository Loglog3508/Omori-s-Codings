...
;(function(global){
  ...
  U.ensureChartJS = async function(){ if(typeof Chart!=='undefined') return true; const CDN = 'https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.min.js'; try{ await U.loadScript(CDN); return typeof Chart!=='undefined'; }catch(e){ U.warn('Chart.js加载失败', e); return false; } };
